...
public class CoreSwitchBean implements Parcelable {
	...
	public CoreSwitchBean(String pageName, Bundle bundle, CoreAnim coreAnim, boolean addToBackStack,
			boolean newActivity, boolean resultUsedClear) {
		this.mPageName = pageName;
		this.mBundle = bundle;
		this.setAnim(coreAnim);
		this.mAddToBackStack = addToBackStack;
	...
	public static int[] convertAnimations(CoreAnim coreAnim) {
		if (coreAnim == CoreAnim.present) {
			int[] animations = { R.anim.comm_push_in_down, R.anim.comm_push_no_ani, R.anim.comm_push_no_ani,
					R.anim.comm_push_out_down };
			return animations;
		} else if (coreAnim == CoreAnim.fade) {
			int[] animations = { R.anim.comm_alpha_in, R.anim.comm_alpha_out, R.anim.comm_alpha_in,
					R.anim.comm_alpha_out };
			return animations;
		} else if (coreAnim == CoreAnim.slide) {
			int[] animations = { R.anim.comm_slide_in_right, R.anim.comm_slide_out_left, R.anim.comm_slide_in_left,
					R.anim.comm_slide_out_right };
			return animations;
		} else if (coreAnim == CoreAnim.zoom) {
			int[] animations = { R.anim.comm_zoom_in, R.anim.comm_zoom_out, R.anim.comm_zoom_in, R.anim.comm_zoom_out };
			return animations;
		}
		return null;
	}
	...
	public String toString() {
		return "SwitchBean{" + "mPageName='" + mPageName + '\'' + ", mBundle=" + mBundle + ", mAnim="
				+ Arrays.toString(mAnim) + ", mAddToBackStack=" + mAddToBackStack + ", mNewActivity=" + mNewActivity
				+ ", requestCode=" + requestCode + ", mResultUsedClear=" + mResultUsedClear + '}';
	}
