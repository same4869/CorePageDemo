...
public class CorePageFragment extends Fragment {
	...
	public final Fragment findPageByName(String pageName) {
		...
		if (coreSwitcher != null) {
			return coreSwitcher.findFragmentByName(pageName);
		} else {
			return null;
		}
	}
	...
	public void onDestroy() {
		...
		// BangbangApplication.getInstance().getRefWatcher();
	...
	public void printStash() {
		Log.e("ljj", this.getPageName() + " isAdded:" + this.isAdded());
		Log.e("ljj", this.getPageName() + " isHidden:" + this.isHidden());
		Log.e("ljj", this.getPageName() + " isDetached:" + this.isDetached());
		Log.e("ljj", this.getPageName() + " isInLayout:" + this.isInLayout());
		Log.e("ljj", this.getPageName() + " isResumed:" + this.isResumed());
		Log.e("ljj", this.getPageName() + " isRemoving:" + this.isRemoving());
		Log.e("ljj", this.getPageName() + " isVisible:" + this.isVisible());
	}
